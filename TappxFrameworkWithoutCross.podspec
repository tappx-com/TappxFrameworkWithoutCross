...
Pod::Spec.new do |spec|
  spec.name         = "TappxFrameworkWithoutCross"
  spec.version      = "4.0.8"
  spec.summary      = "Tappx SDK for iOS monetization (This is the SDK without GoogleMobileAds)."
  ...
  spec.source       = { :git => "https://github.com/tappx-com/TappxFrameworkWithoutCross.git", :tag => "#{spec.version}" }
  ...
  spec.subspec 'TappxFramework' do |ss|
    ...
    ss.platform = :ios
    ss.ios.deployment_target  = '11.0'
    ss.dependency "TappxFrameworkWithoutCross/OMSDK_Tappx"
    ss.xcconfig = { 
      "OTHER_LDFLAGS" => "-ObjC"
    }
  end
